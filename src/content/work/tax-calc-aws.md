...
company: Intuit
summary: Architected an event-driven authoring & debugging tool on AWS — then led its strategic deprecation, with five-figure annual infrastructure savings.
...
impact: Delivered a working authoring-and-debugging capability on a scalable, reproducible AWS footprint — and, when it was the right decision, retired it cleanly to save a five-figure annual infrastructure cost. Knowing when to sunset a system is as much engineering as building it.
...
moved on, then leading a clean migration off it to save five figures a year, was the
